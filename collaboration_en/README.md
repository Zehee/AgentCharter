...
**Version**: v3.4 | **Updated**: 2026-06-11
...
| Use tools (external Agent, optional) | Run `python collaboration_en/scripts/agent.py YOUR_NAME` |
| Use tools (TPM) | Run `python collaboration_en/scripts/tpm.py TPM` |
