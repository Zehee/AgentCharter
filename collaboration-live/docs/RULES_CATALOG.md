...
> 版本：v2.6 | 日期：2026-06-11 | 适用：AgentCharter v3.3
...
- 2026-06-11 v2.6：补充 19 条遗漏规则（文档优先级链、审查标准三级定义、自循环约束、打回机制、归档例外、context/ 专用性、已读标识位置、reviews/ 权限、agent_id 运行时属性、.gitignore 规则等）。
